...
class _MainScreenState extends State<MainScreen> {
  ...
  final List<Map> _users = [
    {'id': 'id', 'name': 'Route', 'stops': 'Stops', 'miles': 'Miles',},
    {'id': 1, 'name': 'John', 'stops': 1, 'miles': 1,},
    {'id': 2, 'name': 'Bob', 'stops': 1, 'miles': 1,},
    {'id': 3, 'name': 'Trump', 'stops': 1, 'miles': 1,},
    {'id': 4, 'name': 'Joe Biden', 'stops': 1, 'miles': 1,},
    {'id': 5, 'name': 'Superman', 'stops': 1, 'miles': 1,},
    {'id': 6, 'name': 'Wonder Lady', 'stops': 1, 'miles': 1,},
    {'id': 7, 'name': 'Ronaldo', 'stops': 1, 'miles': 1,},
    {'id': 8, 'name': 'Ben', 'stops': 1, 'miles': 1,}
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text('European Night Trains',
            style: TextStyle(
